description = [
    ...
    },
    {
        ...
        "optional_parameters": [
            {"name": "endpoint", "type": "str", "description": "Direct API path or full URL to ClinicalTrials.gov endpoint", "default": None},
            {"name": "term", "type": "str", "description": "Free-text search term", "default": None},
            {"name": "status", "type": "str", "description": "Overall recruitment status filter, e.g., RECRUITING", "default": None},
            ...
            {"name": "location", "type": "str", "description": "Location filter (country, city, etc.)", "default": None},
            {"name": "phase", "type": "str", "description": "Trial phase filter (e.g., PHASE1, PHASE2, PHASE3)", "default": None},
            ...
            {"name": "api_key", "type": "str", "description": "LLM API key for prompt-to-params translation (optional)", "default": None},
            {"name": "model", "type": "str", "description": "LLM model name for prompt translation", "default": "claude-3-5-haiku-20241022"},
            {"name": "verbose", "type": "bool", "description": "Whether to return detailed response structure", "default": True}
        ],
        "required_parameters": [
            {"name": "prompt", "type": "str", "description": "Natural language query about clinical trials (if no endpoint/params provided)", "default": None}
        ]
    },
    {
