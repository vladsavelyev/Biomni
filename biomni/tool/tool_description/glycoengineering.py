description = [
    {
        ...
        "required_parameters": [
            {"name": "sequence", "type": "str", "description": "Protein sequence (one-letter AA codes)", "default": None}
        ],
        "optional_parameters": [
            {"name": "allow_overlap", "type": "bool", "description": "Allow overlapping motif detections", "default": False}
        ],
    },
    {
        ...
        "optional_parameters": [
            ...
            {"name": "min_st_fraction", "type": "float", "description": "Min S/T fraction in window to flag site", "default": 0.4},
            {"name": "disallow_proline_next", "type": "bool", "description": "Avoid S/T immediately followed by Proline", "default": True},
        ],
    },
    {
